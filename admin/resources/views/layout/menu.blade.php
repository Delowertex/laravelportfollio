            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-collapse">
                    <ul class="mr-auto navbar-nav mt-md-0">
                     ...
                     <li class="mt-3 nav-item">ADMIN</li>
					</ul>
        ...
        <aside class="left-sidebar">
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="mt-0 nav-devider" style="margin-bottom: 5px"></li>
                        ...
                        <li> <a href="{{url('/project')}}" ><span> <i class="fas fa-lock"></i> </span><span class="hide-menu">Project</span></a></li>
                        <li> <a href="{{url('/contact')}}" ><span> <i class="fas fa-id-badge"></i> </span><span class="hide-menu">Contact</span></a></li>
                        <li> <a href="{{url('/review')}}" ><span> <i class="fas fa-search-location"></i> </span><span class="hide-menu">Review</span></a></li>
                        <li> <a href="{{url('/gallery')}}" ><span> <i class="fas fa-search-location"></i> </span><span class="hide-menu">Photo Gallery</span></a></li>
					</ul>
                </nav>
            </div>
        </aside>
